...
//*******************************************************************************************************************************************
function getFirst20AvailableAppointments($year,$month,$employeeId=false)
{
...
// 					echo $listIndex."<br/>";
		...
		//$month++;// במידה ולא נמצאו 20 תורים על פני חודש שלם תעבור לחודש הבא
	}
...
var_dump(getFirst20AvailableAppointments("2017","01",2)) ;
