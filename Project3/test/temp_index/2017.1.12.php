...
// 			$day = $singleDay->getDay();
			...
			$possibleAppointmentsList =  getPossibleAppointmentsList_ByDay($possibleAppointmentsList,$singleDay);
...
function getPossibleAppointmentsList_ByDay($possibleAppointmentsList,WorkHours $singleDay)
{
